...
class Cliente(Base):
    ...
    garantias_celular = relationship(
        "GarantiaCelular",
        back_populates="cliente"
    )

    garantias_tela = relationship(
        "GarantiaTela",
        back_populates="cliente"
    )
...
class Usuario(Base):
    ...
    pode_cadastrar_cliente = Column(
        Boolean,
        default=False
    )

    pode_editar_cliente = Column(
        Boolean,
        default=False
    )

    pode_ver_produtos = Column(
        Boolean,
        default=False
    )

    pode_cadastrar_produto = Column(
        Boolean,
        default=False
    )

    pode_editar_produto = Column(
        Boolean,
        default=False
    )

    pode_alterar_estoque = Column(
        Boolean,
        default=False
    )

    pode_abrir_caixa = Column(
        Boolean,
        default=False
    )

    pode_fechar_caixa = Column(
        Boolean,
        default=False
    )

    pode_fazer_sangria = Column(
        Boolean,
        default=False
    )

    pode_fazer_suprimento = Column(
        Boolean,
        default=False
    )

    pode_ver_relatorios = Column(
        Boolean,
        default=False
    )

    pode_usar_orcamentos = Column(
        Boolean,
        default=False
    )

    pode_excluir_registros = Column(
        Boolean,
        default=False
    )

    pode_cadastrar_usuarios = Column(
        Boolean,
        default=False
    )
...
class GarantiaCelular(Base):
    ...
    cliente = relationship(
        "Cliente",
        back_populates="garantias_celular"
    )
...
class GarantiaTela(Base):
    ...
    qualidade_tela = Column(
        String(100),
        nullable=True
    )

    servico_realizado = Column(
        String(255),
        nullable=True
    )

    valor_servico = Column(
        Float,
        default=0
    )

    condicoes_aparelho = Column(
        Text,
        nullable=True
    )

    testes_realizados = Column(
        Text,
        nullable=True
    )
